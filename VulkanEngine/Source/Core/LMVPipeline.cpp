...
LMVPipeline::LMVPipeline(LMVDevice& device, const std::string& vertexShaderPath, const std::string& pixelShaderPath, const PipelineConfigInfo& configInfo) : m_device(device)
{
	createGraphicsPipeline(vertexShaderPath, pixelShaderPath, configInfo);
}

LMVPipeline::~LMVPipeline()
{
...
std::vector<char> LMVPipeline::readFile(const std::string& filePath)
{
...
void LMVPipeline::createGraphicsPipeline(const std::string& vertexShaderPath, const std::string& pixelShaderPath, const PipelineConfigInfo& config)
{
...
void LMVPipeline::createShaderModule(const std::vector<char>& code, VkShaderModule* shaderModule)
{
