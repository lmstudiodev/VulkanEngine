...
VkResult LMVSwapChain::acquireNextImage(uint32_t* imageIndex)
{
...
VkResult LMVSwapChain::submitCommandBuffers( const VkCommandBuffer* buffers, uint32_t* imageIndex) 
{
...
void LMVSwapChain::createImageViews()
{
...
void LMVSwapChain::createRenderPass() 
{
...
void LMVSwapChain::createFramebuffers() 
{
...
void LMVSwapChain::createDepthResources() 
{
...
void LMVSwapChain::createSyncObjects()
{
...
VkSurfaceFormatKHR LMVSwapChain::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) 
{
...
VkPresentModeKHR LMVSwapChain::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes)
{
...
VkExtent2D LMVSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) 
{
...
VkFormat LMVSwapChain::findDepthFormat()
{
